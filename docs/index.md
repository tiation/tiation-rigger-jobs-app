---
layout: default
title: Tiation Rigger Jobs App - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Rigger Jobs App</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-rigger-jobs-app" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
![Architecture Diagram](../assets/architecture/tiation-rigger-jobs-app-architecture.svg)
...
```bash
# Build Docker image
docker build -t tiation-rigger-jobs-app .

# Run container
docker run -p 8080:8080 tiation-rigger-jobs-app
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-rigger-jobs-app)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-rigger-jobs-app/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-rigger-jobs-app/discussions)
